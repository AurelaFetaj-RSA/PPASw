        ...
        private void buttonM1TestSaveProgram_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dummyS != null && dummyS.Count > 0 && dummyS[0] is ReadProgramsService progRS)
                {
                    ...
                    float p1 = float.Parse(dataGridViewM1TestPoints[1, 0].Value.ToString());
                    float p2 = float.Parse(dataGridViewM1TestPoints[1, 1].Value.ToString());
                    float p3 = float.Parse(dataGridViewM1TestPoints[1, 2].Value.ToString());
                    float p4 = float.Parse(dataGridViewM1TestPoints[1, 3].Value.ToString());
